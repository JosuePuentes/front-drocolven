...
export const ProductoItem = ({ producto, onAgregar, descuentoCliente1, descuentoCliente2 }: Props) => {
  ...
  const handleAgregar = () => {
    ...
    console.log("Producto a agregar:", { ...producto, cantidad: cantidadValida, precio_n: precioNeto });
    onAgregar({ ...producto,descuento3:descuentoCliente1,descuento4:descuentoCliente2, cantidad_pedida: cantidadValida, precio_n: precioNeto });
