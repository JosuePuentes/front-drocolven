              ...
              <div>
                ...
                <ul className="divide-y divide-gray-100">
                  {p.productos?.map((prod: any, idx: number) => {
                    ...
                    const subtotalConDescuentos =
                      precioConDescuentos * cantidad;
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="text-xs text-gray-500 mt-1 flex flex-wrap gap-3">
                            <span>
                              Cant. pedida: <strong>{cantidad}</strong>
                            </span>
                            <span>
                              Encontrada:{" "}
                              <strong>
                                {getNumber(prod.cantidad_encontrada)}
                              </strong>
                            </span>
                            <span>
                              Precio base: <strong>${precio.toFixed(2)}</strong>
                            </span>
                            <span className="text-blue-700">
                              Subtotal c/desc:{" "}
                              <strong>
                                ${subtotalConDescuentos.toFixed(2)}
                              </strong>
                            </span>
                          </div>
                        </div>
